...
public class ATM1 {
	...
	public static void main(String[] args)   //Main Method. The execution starts from this method
	{
		...
		String accname = "  Ravina Dhumal";    //Declaring the account details
		String branchname = "pimpari(west)";
		String branchaddress = "C-002, swami Apartment, cv Road, Borivali (west), pimpari";
